"""report_html — convert report.json into a self-contained HTML research report."""
...
<head>
  ...
  <title>androDumper Report — {dump_dir.name}</title>
  <style>{_CSS}</style>
</head>
<body>
  <div class="header">
    <h1>androDumper Research Report</h1>
    <div class="meta">Dump: {dump_dir}  |  Generated by androDumper</div>
  </div>
  <div class="container">
    {sections}
  </div>
